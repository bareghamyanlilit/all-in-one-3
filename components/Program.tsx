...
export function Program() {
  return (
    <div className="FontOptimaModoki py-5 tracking-[25%]">
        ...
        {program.map((el: any, i: number) => {
          return (
            ...
            >
              ...
              >
                <motion.h2 {...anim} className="tracking-[25%] text-[32px]">
                  {el.time}
                </motion.h2>
                <motion.p
                  {...anim}
                  className="tracking-[25%] text-lg font-bold relative"
                >
                  {el.title}
                </motion.p>
                <motion.h3
                  {...anim}
                  className={`${i % 2 != 0 ? "flex-row-reverse " : " "} tracking-[25%] flex justify-start gap-2 items-center text-sm`}
                >
                  <span>Հասցե</span>
                  <Image
                    src="/icon3.png"
